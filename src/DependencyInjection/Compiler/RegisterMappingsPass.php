...
namespace Mukadi\WordpressBundle\DependencyInjection\Compiler;
...
class RegisterMappingsPass implements CompilerPassInterface
{
    ...
    {
        foreach (['mukadi_wordpress.model_manager_name', $this->fallbackManagerParameter] as $param) {
    ...
    public static function createOrmMappingDriver(array $mappings)
    {
        ...
        return new self($driver, 'doctrine.orm.%s_metadata_driver', $mappings, 'mukadi_wordpress.backend_type_orm', 'doctrine.default_entity_manager');
    }
}
